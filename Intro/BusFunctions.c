...
//A.N Modified the create reservation function 
...
void relocate_user(Reservation* reservations) {
    ...
    generate_ticket_id(to_reservation.ticket_id);
    display_new_reservation_details(to_reservation);
}
...
void display_new_reservation_details(Reservation reservation) {
    ...
    printf("Phone number: %s\n", reservation.phone_number);
    printf("Seat number: %d\n", reservation.seat_number);
    printf("Bus number: same as above\n");
    printf("Ticket ID: %s\n", reservation.ticket_id);
